# Push SAP ERP EMEA knowledge to ARIA
$ARIA_API = "http://localhost:4001"
$entries = Get-Content -Path "$PSScriptRoot\aria_sap_erp_emea.json" -Raw | ConvertFrom-Json

Write-Host "=== Pushing SAP ERP EMEA knowledge to ARIA ===" -ForegroundColor Cyan

# Push batch 2 of 10 app profiles to ARIA
$ARIA_API = "http://localhost:4001"
$entries = Get-Content -Path "$PSScriptRoot\aria_10_apps_batch2.json" -Raw | ConvertFrom-Json

Write-Host "=== Pushing batch 2 of 10 app profiles to ARIA ===" -ForegroundColor Cyan
$ok = 0; $fail = 0
